...
class Cash extends StatefulWidget {
  ...
  const Cash({Key? key, required this.items}) : super(key: key);
...
class _CashState extends State<Cash> {
  ...
  Widget build(BuildContext context) {
    ...
    void uploadToFireBase({String? cash}) {
      ChAvailableCash()
          .uploadData(nameCharity: selectedName, cash: cash);
    }
                          ...
                          child: Column(
                            children: [
                              Padding(
                                ...
                                child: Center(
                                  child: Text("The Donation : "+
                                    widget.items["Donation Amount"],
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      child: ElevatedButton(
                                        ...
                                        onPressed: () {
                                          uploadToFireBase(cash: widget.items["Donation Amount"]);
